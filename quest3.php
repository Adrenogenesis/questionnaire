...
<div class="main">
<div class="quest">
<select id="selectq1" name="category" onchange="fx()">
			<option id="questions" value="Defaut" selected>Questions</option>
            <option id="quts1" value="quts1" onclick="qut1()">
...
while ($row = $stmt->fetch()){ 
    echo $row['question1'];}?>
      ...
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
            ...
            <input type="submit" name="Quest3" value="submit"></button>
        </form>
...
if(isset($_POST['inputType'])){
    ...
    // $sql = "SELECT COUNT(username) AS num FROM Statutquiz WHERE username = :username";
